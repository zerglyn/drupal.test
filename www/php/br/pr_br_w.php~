<?php
	...
	$row_pr_br_w = mysql_fetch_array($res_pr_br_w);
	if ($row_pr_br_w['sum_pr_w'] != NULL)
		$pr_br_w = "<a href=\"money_in/week/br\"><span style=\"color:#3ce42e; font-weight: bold; font-size: large; \">".number_format($row_pr_br_w['sum_pr_w'], 0, '.', ' ')."</span></a>";
	else $pr_br_w = "<span style=\"color:#515151;\"><b>Ничего нет</b></span>";
	echo $pr_br_w;
?>
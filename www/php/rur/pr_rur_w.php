<?php
	...
	$row_pr_rur_w = mysql_fetch_array($res_pr_rur_w);
	if ($row_pr_rur_w['sum_pr_w'] != NULL)
		$pr_rur_w = "<a href=\"money_in/week/rur\"><span style=\"color:#3ce42e; font-weight: bold; font-size: large; \">".number_format(	$row_pr_rur_w['sum_pr_w'], 0, '.', ' ')."</span></a>";
	else $pr_rur_w = "<span style=\"color:#515151;\"><b>Ничего нет</b></span>";
	echo $pr_rur_w;
?>
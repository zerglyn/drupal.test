<?php
	...
	$row_pl_rur_Y = mysql_fetch_array($res_pl_rur_Y);
	if ($row_pl_rur_Y['sum_pl_Y'] != NULL)
		$pl_rur_Y = "<a href=\"money_out/year/rur\"><span style=\"color:#f20606; font-weight: bold; font-size: large; \">".number_format(	$row_pl_rur_Y['sum_pl_Y'], 0, '.', ' ')."</span></a>";
	else $pl_rur_Y = "<span style=\"color:#515151;\"><b>Ничего нет</b></span>";	
	echo $pl_rur_Y;				 
?>

<?php
	...
	$row_pr_rur_Y = mysql_fetch_array($res_pr_rur_Y);
	if ($row_pr_rur_Y['sum_pr_Y'] != NULL)
		$pr_rur_Y = "<a href=\"money_in/year/rur\"><span style=\"color:#3ce42e; font-weight: bold; font-size: large; \">".number_format(	$row_pr_rur_Y['sum_pr_Y'], 0, '.', ' ')."</span></a>";
	else $pr_rur_Y = "<span style=\"color:#515151;\"><b>Ничего нет</b></span>";
	echo $pr_rur_Y;
?>